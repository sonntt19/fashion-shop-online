...
<html>
    ...
    <body>
        <div class="container rounded bg-white mt-5 mb-5" style="padding-bottom: 158px;">
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-8">
                    <div class="p-3 py-5">
                        ...
                        <div class="mt-5 text-center"><button class="btn btn-dark" type="button">Lưu</button></div>
                    </div>
                </div>
            </div>
        </div>
