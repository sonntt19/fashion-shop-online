            ...
            <div class="center">
                <form action="update_product" method="post">
                    ...
                    <table style="background-color: window ; width: 60%">
                        ...
                        <tr>
                            <td>Địa chỉ ảnh:</td>
                            <td><input type="text" name="imageUrl" value="${product.image}"/><br/></td>
                        </tr>
                        <tr>
                            <td>Giá gốc:</td>
                        ...
                        <tr>
                            <td>Miêu tả :</td>
                            <td>
                                <textarea rows="3" cols="80" name="comment" form="usrform">
                                    ${product.desciption}
                                </textarea>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <c:if test="${product.status == true}">
                                    <input type="radio" name="status" value="${product.status}" checked="checked" />Hiện
                                </c:if>
                                <c:if test="${product.status == false}">
                                    <input type="radio" name="status" value="${product.status}" checked="checked" />Ẩn
                                </c:if>
                            </td>
                        </tr>
                        <tr>
